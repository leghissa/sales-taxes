...
public class AggregatingSalesTaxCalculatorTest {
    ...
    public void taxIsZeroIfNoSalesTaxRateProvidersAreSupplied(){
        ...
        final SalesTaxCalculator calculateAggregatedSalesTax = new AggregatingSalesTaxCalculator(emptySet(), salesTaxRounder);
    ...
    public void taxIsExpectedWithSingleSalesTaxRateProvider(){
        ...
        final SalesTaxCalculator calculateAggregatedSalesTax = new AggregatingSalesTaxCalculator(singleton((p) -> 10), salesTaxRounder);
        when(salesTaxRounder.apply(expectedTax)).thenReturn(expectedTax);
    ...
    public void taxIsAggregatedWithMultipleSalesTaxRateProviders(){
        ...
        final SalesTaxCalculator calculateAggregatedSalesTax = new AggregatingSalesTaxCalculator(new HashSet<>(asList(provider1, provider2)), salesTaxRounder);
        when(salesTaxRounder.apply(expectedTax)).thenReturn(expectedTax);
    ...
    public void taxIsRounded(){
        ...
        final SalesTaxCalculator calculateAggregatedSalesTax = new AggregatingSalesTaxCalculator(singleton(provider1), salesTaxRounder);
    ...
    public void salesTaxRateProvidersShouldNotBeNull(){
        ...
        new AggregatingSalesTaxCalculator(null, salesTaxRounder);
    }
    ...
    public void roundSalesTaxShouldNotBeNull(){
        ...
        new AggregatingSalesTaxCalculator(emptySet(), null);
    }
